...
class Ui_MSql_win2(object):
    def setupUi(self, MSql_win2):
        ...
        self.o_table.setDragEnabled(True)
        self.o_table.setDragDropMode(QtWidgets.QAbstractItemView.DragOnly)
        self.o_table.setDefaultDropAction(QtCore.Qt.CopyAction)
