...
class Ui_history_window(object):
    def setupUi(self, history_window):
        ...
        self.gridLayout.addWidget(self.o_lst1, 3, 0, 1, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/indent.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_insert_in_editor.setIcon(icon3)
        self.b_insert_in_editor.setObjectName("b_insert_in_editor")
        self.gridLayout.addWidget(self.b_insert_in_editor, 4, 0, 1, 1)
