...
class Ui_program_info(object):
    ...
    def retranslateUi(self, program_info):
        ...
        self.label_2.setText(_translate("program_info", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600;\">MSql Editor</span></p><p align=\"center\"><span style=\" font-size:12pt;\">MSql Editor is a SQL text editor for ORACLE environment.</span></p><p align=\"center\"><span style=\" font-size:12pt;\">Developed by </span><span style=\" font-size:12pt; font-weight:600;\">Marco Valaguzza</span></p><p align=\"center\"><span style=\" font-size:12pt;\">with Python 3.13, PyQt6 and Scintilla</span></p><p align=\"center\"><span style=\" font-size:10pt;\">Version 1.0 (2023-2025)</span></p><p align=\"center\"><span style=\" font-size:12pt;\">a special thanks to Filippo Damiani and Marco Traini</span></p><p align=\"center\"><br/></p><p align=\"center\">This program is free software: you can redistribute it and/or modify it under the terms </p><p align=\"center\">of the GNU General Public License as published by the Free Software Foundation, </p><p align=\"center\">either version 3 of the License, or (at your option) any later version.</p><p align=\"center\">This program is distributed in the hope that it will be useful, </p><p align=\"center\">but WITHOUT ANY WARRANTY!!! Without even the implied warranty of </p><p align=\"center\">MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. </p><p align=\"center\">See the GNU General Public License for more details at www.gnu.org/licenses/<br/></p></body></html>"))
