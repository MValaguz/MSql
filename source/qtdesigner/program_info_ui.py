...
class Ui_program_info(object):
    ...
    def retranslateUi(self, program_info):
        ...
        self.label_2.setText(_translate("program_info", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600;\">MSql Editor </span><span style=\" font-size:10pt;\">(2023-2026)</span></p><p align=\"center\"><span style=\" font-size:12pt;\">MSql Editor is a SQL text editor for ORACLE environment.</span></p><p align=\"center\"><span style=\" font-size:12pt;\">Developed by </span><span style=\" font-size:12pt; font-weight:600;\">Marco Valaguzza </span></p><p align=\"center\"><span style=\" font-size:12pt;\">with Python 3.13, PyQt6 and QScintilla</span></p></body></html>"))
